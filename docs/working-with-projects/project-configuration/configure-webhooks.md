...
### Teams Endpoint Payload Example

For Microsoft Teams, Harbor sends a message card:

```json
{
  "@type": "MessageCard",
  "@context": "http://schema.org/extensions",
  "summary": "Harbor Webhook Event",
  "title": "Harbor Webhook Event",
  "sections": [
    {
      "activityTitle": "PUSH_ARTIFACT",
      "activitySubtitle": "Operator: admin | Timestamp: 2023-04-03T06:04:46Z",
      "facts": [
        {
          "name": "Repository",
          "value": "harbor/alpine"
        ...
        {
          "name": "Digest",
          "value": "sha256:954b378c375d852eb3c63ab88978f640b4348b01c1b3456a024a81536dafbbf4"
        }
      ]
    }
  ]
...
For Microsoft Teams endpoints, you should create a webhook connector in your Teams channel following the [Teams webhook guide](https://docs.microsoft.com/en-us/microsoftteams/platform/webhooks-and-connectors/how-to/add-incoming-webhook).

When you select the Teams notify type, Harbor will format the notification as a Teams message card.
...
1. Select the notify type from the available options: `HTTP`, `SLACK`, or `TEAMS`.
